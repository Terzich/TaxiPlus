...
readonly url = environment.url + "question";
  ...
  private faqs : FAQ[] = [
    new FAQ(1, "Koje je radno vrijeme vaše poslovnice?", 1, "Naše radno vrijeme je od 08:00h do 20:00h svakim radnim danom, vikendi su neradni s tim da je svaka 3 subota radna!"),
    new FAQ(2, "Da li je moguće iznajmiti vozilo na duži period?", 2, "Da, ukoliko ste zainteresovani, imate mogućnost iznajmljivanja vozila putem ove aplikacije."),
